...
my @tests = (
    ...
    [ no_hash_keys => JSON::Schema::Fit->new(hash_keys => 0),
        {aa => JSON::true, bb => 20, cc => 33.33, dd => "77", _debug => "stacktrace"},
    ],
