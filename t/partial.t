...
my @tests = (
    ...
    [ no_crop_numbers =>     JSON::Schema::Fit->new(crop_numbers => 0),       {aa => JSON::true, bb => 20, cc => 33.33, dd => 77, ee => 8, ff => 4, gg => 10, hh => 6.4} ],
    ...
    [ disable_all =>    JSON::Schema::Fit->new(map {$_ => 0} qw/booleans numbers round_numbers strings hash_keys crop_numbers/), $raw_data ],
);
